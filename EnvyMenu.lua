...
local function KJLU_fake_script() -- OpenMenu.Open/Close Menu 
...
coroutine.wrap(KJLU_fake_script)()
local function NWUDVD_fake_script() -- Fullbright.Fullbright 
...
coroutine.wrap(NWUDVD_fake_script)()
local function LKXRRCZ_fake_script() -- Speedhack.Speedhack 
...
coroutine.wrap(LKXRRCZ_fake_script)()
local function ZMFRVB_fake_script() -- ESP.ESP 
...
coroutine.wrap(ZMFRVB_fake_script)()
local function MAVVB_fake_script() -- Aimbot.Aimbot 
...
coroutine.wrap(MAVVB_fake_script)()
local function FWDQ_fake_script() -- Lay.Lay 
...
coroutine.wrap(FWDQ_fake_script)()
local function YIAOUT_fake_script() -- Gravity.Gravity 
	...
	textBox.FocusLost:Connect(function(enterPressed)
		if enterPressed then
			...
			if input then
				currentGravity = input
				textBox.PlaceholderText = "GRAVITY: " .. input
				textBox.Text = ""
	
				if input == defaultGravity then
					removeGravity()
				else
					setGravity(input)
				end
...
coroutine.wrap(YIAOUT_fake_script)()